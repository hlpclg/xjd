...
function category_get_goods($children, $brand, $min, $max, $ext, $size, $page, $sort, $order)
{
    ...
    $sql = "SELECT g.goods_id, g.goods_name, g.goods_name_style, g.click_count,g.sales_volume_base, g.goods_number, g.market_price, " .
	...
	if ($sort=='salenum')
	{
		$sql = "SELECT IFNULL(o.num,0) AS salenum, g.goods_id, g.goods_name, g.click_count,g.sales_volume_base, g.goods_number, g.goods_name_style, " .
    ...
    while ($row = $GLOBALS['db']->fetchRow($res))
    {
		...
		$arr[$row['goods_id']]['count']            = $row['sales_volume_base']+selled_count($row['goods_id']);
