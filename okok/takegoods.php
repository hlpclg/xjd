...
if ($_REQUEST['act'] == 'send_by_print')
{
    ...
    while ($j < $send_sum)
    {		
		$tg_pwd= $str2[mt_rand(0,9)].$str2[mt_rand(0,9)].$str2[mt_rand(0,9)].$str2[mt_rand(0,9)].$str2[mt_rand(0,9)].$str2[mt_rand(0,9)];
        $tg_sn = $str2[mt_rand(0,9)].$str2[mt_rand(0,9)].$str2[mt_rand(0,9)].$str2[mt_rand(0,9)].
						$str2[mt_rand(0,9)].$str2[mt_rand(0,9)].$str2[mt_rand(0,9)].$str2[mt_rand(0,9)].$type_id;	
