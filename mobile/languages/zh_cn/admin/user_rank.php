...
$_LANG['integral_min_exists'] = '已经存在一个等级金币下限为 %d 的会员等级';
$_LANG['integral_max_exists'] = '已经存在一个等级金币上限为 %d 的会员等级';

/* JS 语言 */
$_LANG['js_languages']['remove_confirm'] = '您确定要删除选定的会员等级吗？';
$_LANG['js_languages']['rank_name_empty'] = '您没有输入会员等级名称。';
$_LANG['js_languages']['integral_min_invalid'] = '您没有输入金币下限或者金币下限不是一个整数。';
$_LANG['js_languages']['integral_max_invalid'] = '您没有输入金币上限或者金币上限不是一个整数。';
$_LANG['js_languages']['discount_invalid'] = '您没有输入折扣率或者折扣率无效。';
$_LANG['js_languages']['integral_max_small'] = '金币上限必须大于金币下限。';
