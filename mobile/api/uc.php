...
define('API_UPDATECREDIT', 1);  //note 更新用户金币 开关
define('API_GETCREDITSETTINGS', 1);  //note 向 UCenter 提供金币设置 开关
define('API_GETCREDIT', 1);     //note 获取用户的某项金币 开关
define('API_UPDATECREDITSETTINGS', 1);  //note 更新应用金币设置 开关
