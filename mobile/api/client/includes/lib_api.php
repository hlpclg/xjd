<?php
    ...
    { if (get_magic_quotes_gpc()) { $post['UserId'] = $post['UserId'] } else { $post['UserId'] = addslashes($post['UserId']); }
        ...
        if ($row)
        {
            ...
            require_once(ROOT_PATH. ADMIN_PATH_M . '/includes/lib_main.php');
            // 登录成功
    ...
    function API_AddBrand($post)
    {
        ...
        /* 加载后台主操作函数 */
        require_once(ROOT_PATH . ADMIN_PATH_M . '/includes/lib_main.php');
        require_once(ROOT_PATH . ADMIN_PATH_M . '/includes/cls_exchange.php');
    ...
    function API_AddGoods($post)
    {
        ...
        /* 加载后台操作类与函数 */
        require_once(ROOT_PATH . ADMIN_PATH_M . '/includes/lib_main.php');
        require_once(ROOT_PATH . ADMIN_PATH_M . '/includes/lib_goods.php');
        require_once(ROOT_PATH . 'includes/cls_image.php');
